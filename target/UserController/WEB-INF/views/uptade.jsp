   ...
   <table>
    ...
    <tr>
          ...
          <td > <label for="name">Name<em>*</em></label></td>
           <td > <input tabindex="1" size="40" type="text" name="name" id="name" value="${name}"/></td>
        
    </tr>
    
    <tr>
          <td > <label for="surname">Surname<em>*</em></label>  </td>
          <td > <input tabindex="2" size="40" type="text" name="surname" id="surname" value="${surname}"/><td > 
        
    </tr>
    
    <tr>
           <td>  <label for="phone">Contact Number<em>*</em></label> </td>
           <td>  <input tabindex="3" size="40" type="text" name="phone" id="phone" value="${phone}"/></td>
