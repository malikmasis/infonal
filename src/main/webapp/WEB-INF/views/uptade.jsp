...
1${user.name}--${name}-N-${nameNew}2--SN--${surnameNew}--PN--${phoneNew}
   ...
   <table>
    ...
    <tr>
          ...
          <td > <label for="name">Name<em>*</em></label></td>
           <td > <input tabindex="1" size="40" type="text" name="name" id="name" value="${name}"/>--${user.name }--</td>
    ...
    <tr>
          ...
          <td > <input tabindex="2" size="40" type="text" name="surname" id="surname" value="${surname}"/>${user.nameNew }<td > 
        
    </tr>
    
    <tr>
           <td>  <label for="phone">Contact Number<em>*</em></label> </td>
           <td>  <input tabindex="3" size="40" type="text" name="phone" id="phone" value="${phone}"/>${nameNew }</td>
